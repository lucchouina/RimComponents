...
{
    fprintf(stderr,"Got Exception: [%d] long jumping.\n", sig);
    siglongjmp(jmpenv, 0);
}
static void setSig()
{
...
int dbgval;
    ...
    if(!sigsetjmp(jmpenv, 1)) {
        ...
        fprintf(stderr, "Got exception : Not Good!\n");
        exit(1);
    }
fdTest:
#define FNAME "/tmp/trxdbgfdtest"
