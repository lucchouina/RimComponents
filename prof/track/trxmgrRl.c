...
static char *bol, *leftN, *rightN, *upN, *downN, *home;
static char *kup, *kdown, *kleft, *kright, *kdel, *kbksp;
static char *bip, *kwb, *cod, *kwf, *fw, *bw;
